...
item-type: English
item-url: /files/SHP-Transformative-Border-Zones.pdf
item-summary: >-
  This paper focuses on the interconnected organizations Association for

  Historical Dialogue and Research (AHDR) and Home for Cooperation (H4C) as

  successful outcomes of a local bicommunal movement for peace and reconciliation. The

  choice for focusing on these two organizations lies in the fact that they form sustainable

  examples of cooperation in urban contexts that have transformed the buffer zone in the
